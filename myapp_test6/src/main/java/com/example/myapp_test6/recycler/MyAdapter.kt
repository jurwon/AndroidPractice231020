package com.example.myapp_test6.recycler

import android.util.Log
import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.myapp_test6.databinding.MemberRecyclerBinding

//뷰를 모아둔 박스 -> 목록 요소의 뷰,
class MyViewHolder (val binding: MemberRecyclerBinding) : RecyclerView.ViewHolder(binding.root)
...
class MyAdapter (val datas: MutableList<String>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder =
        MyViewHolder(MemberRecyclerBinding.inflate(
